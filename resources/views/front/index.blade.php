...
<body>
    <div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-white">
        <div id="Top-Nav" class="flex items-center justify-between w-full px-4 mt-[60px]">
            <a href="index.html">
                <img src="{{ asset('assets/images/thumbnails/boncahe_logo.png') }}" class="flex shrink-0"
                    alt="logo">
            </a>
            <a href="#">
                        ...
                        <a href="{{ route('front.details', $itemNewTicket->slug) }}" class="card">
                            <div
                                ...
                                <div class="flex items-center gap-[14px]">
                                    <div
                                        class="flex w-[90px] h-[90px] shrink-0 rounded-3xl bg-[#D9D9D9] overflow-hidden">
                                    ...
                                    <div class="flex flex-col gap-[6px]">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <p class="font-semibold text-xs leading-[18px]">
                                                {{ $itemNewTicket->seller->name }}</p>
                                        </div>
                                        <p class="font-bold text-sm leading-[21px] text-[#F97316]">Rp
                                            {{ number_format($itemNewTicket->price, 0, '.', ',') }}</p>
                                    </div>
                                </div>
                                <p
